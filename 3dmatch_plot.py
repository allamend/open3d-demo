# 3dmatch pointcloud with correspondence plot after applying transformation
...
result = np.load('/home/yfenghua/dataset/3dmatch/0_1.npz')
print(result.files)
print(result['src_points_c'].shape)
print(result['src_points_f'].shape)
pc_st = result['src_points_f']
pc_ed = result['ref_points_f']
